...
| campo | valor |
|---|---|
| Snapshot (UTC) | 2026-08-15 01:53:14 |
| Timer | active |
| Proxima corrida | Sun 2026-08-16 02:07:00 CEST  22h Sat 20 |
| Ultima corrida terminou | Sat 2026-08-15 02:07:15 CEST |

## Resumo

| instancia | longs | shorts | corridas | em posicao | lado | kill switch | dry_run | chaves |
|---|---|---|---|---|---|---|---|---|
| **long** | true | false | 21 | false | - | false | true | nao |
| **short** | false | true | 20 | false | - | false | true | nao |
| **both** | true | true | 20 | false | - | false | true | nao |
...
```
2026-08-15 02:07:08,220 [INFO] [long] Flat, no signal. Done.
```
...
```
2026-08-15 02:07:11,437 [INFO] [short] Flat, no signal. Done.
```
...
```
2026-08-15 02:07:14,827 [INFO] [both] Flat, no signal. Done.
```
