...
| campo | valor |
|---|---|
| Snapshot (UTC) | 2026-08-12 03:00:17 |
| Timer | active |
| Proxima corrida | Thu 2026-08-13 02:07:00 CEST  21h Wed 20 |
| Ultima corrida terminou | Wed 2026-08-12 02:07:17 CEST |

## Resumo

| instancia | longs | shorts | corridas | em posicao | lado | kill switch | dry_run | chaves |
|---|---|---|---|---|---|---|---|---|
| **long** | true | false | 18 | false | - | false | true | nao |
| **short** | false | true | 17 | false | - | false | true | nao |
| **both** | true | true | 17 | false | - | false | true | nao |
...
```
2026-08-12 02:07:12,666 [INFO] [long] Flat, no signal. Done.
```
...
```
2026-08-12 02:07:14,901 [INFO] [short] Flat, no signal. Done.
```
...
```
2026-08-12 02:07:17,156 [INFO] [both] Flat, no signal. Done.
```
