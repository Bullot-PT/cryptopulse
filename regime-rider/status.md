...
| campo | valor |
|---|---|
| Snapshot (UTC) | 2026-08-09 02:32:29 |
| Timer | active |
| Proxima corrida | Mon 2026-08-10 02:07:00 CEST  21h Sun 20 |
| Ultima corrida terminou | Sun 2026-08-09 02:07:12 CEST |

## Resumo

| instancia | longs | shorts | corridas | em posicao | lado | kill switch | dry_run | chaves |
|---|---|---|---|---|---|---|---|---|
| **long** | true | false | 15 | false | - | false | true | nao |
| **short** | false | true | 14 | false | - | false | true | nao |
| **both** | true | true | 14 | false | - | false | true | nao |
...
```
2026-08-09 02:07:06,262 [INFO] [long] Flat, no signal. Done.
```
...
```
2026-08-09 02:07:08,911 [INFO] [short] Flat, no signal. Done.
```
...
```
2026-08-09 02:07:11,829 [INFO] [both] Flat, no signal. Done.
```
