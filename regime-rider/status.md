...
| campo | valor |
|---|---|
| Snapshot (UTC) | 2026-07-30 03:36:42 |
| Timer | active |
| Proxima corrida | Fri 2026-07-31 02:07:00 CEST  20h Thu 20 |
| Ultima corrida terminou | Thu 2026-07-30 02:07:24 CEST |

## Resumo

| instancia | longs | shorts | corridas | em posicao | lado | kill switch | dry_run | chaves |
|---|---|---|---|---|---|---|---|---|
| **long** | true | false | 5 | false | - | false | true | nao |
| **short** | false | true | 4 | false | - | false | true | nao |
| **both** | true | true | 4 | false | - | false | true | nao |
...
```
2026-07-30 02:07:19,291 [INFO] [long] Flat, no signal. Done.
```
...
```
2026-07-30 02:07:21,825 [INFO] [short] Flat, no signal. Done.
```
...
```
2026-07-30 02:07:24,336 [INFO] [both] Flat, no signal. Done.
```
