...
| campo | valor |
|---|---|
| Snapshot (UTC) | 2026-07-31 03:55:42 |
| Timer | active |
| Proxima corrida | Sat 2026-08-01 02:07:00 CEST  20h Fri 20 |
| Ultima corrida terminou | Fri 2026-07-31 02:07:08 CEST |

## Resumo

| instancia | longs | shorts | corridas | em posicao | lado | kill switch | dry_run | chaves |
|---|---|---|---|---|---|---|---|---|
| **long** | true | false | 6 | false | - | false | true | nao |
| **short** | false | true | 5 | false | - | false | true | nao |
| **both** | true | true | 5 | false | - | false | true | nao |
...
```
2026-07-31 02:07:03,579 [INFO] [long] Flat, no signal. Done.
```
...
```
2026-07-31 02:07:05,924 [INFO] [short] Flat, no signal. Done.
```
...
```
2026-07-31 02:07:08,388 [INFO] [both] Flat, no signal. Done.
```
