...
| campo | valor |
|---|---|
| Snapshot (UTC) | 2026-08-11 02:31:36 |
| Timer | active |
| Proxima corrida | Wed 2026-08-12 02:07:00 CEST  21h Tue 20 |
| Ultima corrida terminou | Tue 2026-08-11 02:07:14 CEST |

## Resumo

| instancia | longs | shorts | corridas | em posicao | lado | kill switch | dry_run | chaves |
|---|---|---|---|---|---|---|---|---|
| **long** | true | false | 17 | false | - | false | true | nao |
| **short** | false | true | 16 | false | - | false | true | nao |
| **both** | true | true | 16 | false | - | false | true | nao |
...
```
2026-08-11 02:07:09,475 [INFO] [long] Flat, no signal. Done.
```
...
```
2026-08-11 02:07:11,932 [INFO] [short] Flat, no signal. Done.
```
...
```
2026-08-11 02:07:14,508 [INFO] [both] Flat, no signal. Done.
```
